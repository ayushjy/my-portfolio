...
const index = ({card_details}) => {
  ...
  return (
    ...
    <div className=' h-full bg-[#030a12] overflow-x-hidden'>
      <div className='flex flex-col justify-center px-64 py-20 max-md:py-12 max-lg:pb-6 max-xl:pt-16 max-2xl:px-48 max-xl:py-8 max-lg:px-20 max-md:px-8'>
      ...
      <div className='text-gray-400 text-2xl font2 pb-6 w-2/3 max-lg:text-base'>I'm your friendly neighborhood <span className='font4'>Full-Stack Developer.</span> Helping people turn their ideas into sites & apps that work.</div>
      ...
      <Aboutme/>
      <div id='work' ref={targetRef}><Work card_details={card_details}/></div>     
      <Aboutways/>
      <Aboutwhy/>
      <Contact/>
    </div>
